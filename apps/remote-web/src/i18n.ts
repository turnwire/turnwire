...
const en = {
  'error.IMAGE_INPUT_UNSUPPORTED': 'This runtime or selected model does not support image input. Your draft has been kept.',
  'error.IMAGE_NOT_FOUND': 'This image is unavailable or belongs to another session.',
  'error.INVALID_IMAGE': 'This image is invalid or exceeds the allowed limits.',
  'error.IMAGE_QUEUE_EDIT_UNSUPPORTED': 'Queued image messages cannot be edited. Remove and send a new message instead.',
  'image.add': 'Attach images',
  'image.remove': 'Remove image',
  'image.attachment': 'Image attachment',
  'image.hint': 'Up to 2 images, 256 KiB each. Model support varies; animation may use only the first frame.',
  'image.dimensions': 'Images must be at most 40 megapixels and 16,384 pixels per side.',
  'image.unsupported': 'This runtime does not support image transport. The selected model may also reject images.',
  'image.type': 'Choose PNG, JPEG, WebP or GIF images only; SVG is not supported.',
  'image.originalLimit': 'The original image must be 10 MiB or smaller.',
  'image.invalid': 'This image could not be decoded.',
  'image.largeAnimated': 'WebP and GIF must be at most 256 KiB and 1600 pixels. Resize before attaching.',
  'image.size': 'This image could not be reduced below 256 KiB.',
  'image.count': 'Attach at most 2 images (512 KiB total).',
  'image.textLimit': 'Messages with images are limited to 16,000 text characters.',
  'image.compressed': 'Images were resized or compressed before sending; fine detail may be lost.',
  'image.processing': 'Preparing images…',
  'image.loadError': 'Image unavailable — retry',
  ...
  'topbar.deviceConnection': 'Settings',
  'topbar.inbox': 'Approvals',
  'topbar.workspace': 'Workspace',
  'sessionList.more': 'More actions for {title}',
  'sessionList.manage': 'Manage session {title}',
  'sessionList.rename': 'Rename',
  'sessionList.newName': 'New session name',
  'sessionList.saveName': 'Save name',
  'sessionList.archive': 'Archive session',
  'sessionList.cancel': 'Cancel',
  'sessionList.failed': 'Session management failed. Please try again.',
  'sessionList.failedFor': 'Could not update “{title}”',
  'sessionList.dismissError': 'Dismiss error',
  'sessionList.unavailable': 'This session cannot be updated right now.',
  'topbar.connectionSettings': 'Settings',
  ...
  'conversation.historyFailed': 'Could not load history. Scroll up to retry.',
  ...
  'queue.remove': 'Cancel',
  'queue.steer': 'Steer',
  'queue.nextStep': 'Steering pending · after the current step',
  'queue.nextTurn': 'Queued · after the current turn',
  'queue.steerHint': 'Delivered at the next step boundary; does not interrupt the current model response or tool.',
  'context.unknown': 'Context unknown',
  'context.help': 'Next-request context is an estimate; last-request usage is provider-reported. Not cumulative token consumption.',
  'context.estimated': 'Estimated next request',
  'context.reported': 'Last request',
  ...
  'execution.olderStatus': 'Older snapshot · live updates paused',
  'execution.liveStatus': 'Latest window · live updates',
  'execution.inactiveStatus': 'Latest window · inactive (not necessarily finished)',
  'execution.offline': 'Offline — displayed execution may be stale. Reconnect to refresh.',
  'execution.stale': 'Stale execution — {error}',
  'execution.loadError': 'Could not load execution — {error}',
  'execution.retry': 'Retry',
  'execution.loading': 'Loading execution…',
  'execution.empty': 'No execution output yet.',
  'execution.latestOutput': 'Latest output',
  'execution.complete': 'Complete',
  'execution.input': 'Input',
  'execution.pendingResult': 'Not returned yet',
  'execution.inProgress': 'In progress',
  'execution.role.user': 'user',
  'execution.role.assistant': 'assistant',
  'execution.role.error': 'error',
  'execution.older': 'Older page',
  'execution.latestReset': 'Return to latest (reset)',
  'execution.refresh': 'Refresh latest',
  'execution.pagingHint': 'Each page replaces the window, not a continuous transcript. Older browsing keeps its scroll position and pauses live updates.',
  ...
  // Opening one: what the runtime says about that child, and the plan it is working through.
  'agents.detailAria': 'Details for {label}',
  'agents.detailShow': 'Show details',
  'agents.detailHide': 'Hide details',
  'agents.plan': 'Plan',
  'agents.noPlan': 'This agent reports no plan; the runtime only says it is still working.',
  'agents.modeOneShot': 'One-shot',
  'agents.modeContinuable': 'Can continue',
  'agents.under': 'Under {label}',
  'agents.depth': 'Nested {depth} levels below this session',
  'agents.todoPending': 'Not started',
  'agents.todoInProgress': 'In progress',
  'agents.todoCompleted': 'Done',
  'agents.showAll': 'Show all {count}',
  'agents.collapse': 'Show fewer',
  ...
  'create.browseHint': 'If the host has not been updated, type the path instead.',
  'create.useFolder': 'Use this folder',
  'create.newFolder': 'New folder',
  'create.folderName': 'Folder name',
  'create.folderNameHint': 'Enter one folder name, not a path (no slashes or backslashes, and not . or ..).',
  'create.createFolder': 'Create folder',
  'create.creatingFolder': 'Creating folder…',
  ...
  'connection.remember': 'Remember connection in this browser',
  'settings.currentConnection': 'Current connection',
  'settings.savedHost': 'Saved host',
  'settings.replaceConnection': 'Replace connection',
  'settings.disconnect': 'Disconnect and forget',
  'settings.back': 'Back',
  'settings.cancel': 'Cancel',
  'settings.rememberHint': 'Only enable on your own device. This saves connection credentials in this browser; it grants no additional permissions.',
  'settings.storageFailed': 'Could not update browser storage. Your preference was not changed. Check browser storage permissions and try again.',
  'settings.invalidConnection': 'Invalid connection details. Check the pairing code or host URL and token. The previous connection has not been replaced.',
  'inbox.rememberHint': 'Notifications do not remember your connection. To reconnect after closing the browser, enable remembering in Settings.',
  ...
  'error.QUEUE_ITEM_STARTED': 'That prompt has already started running and cannot be taken back.',
...
const zh: Catalog = {
  'error.IMAGE_INPUT_UNSUPPORTED': '此运行时或所选模型不支持图片输入，草稿已保留。',
  'error.IMAGE_NOT_FOUND': '图片不可用或属于其他会话。',
  'error.INVALID_IMAGE': '图片无效或超过允许的限制。',
  'error.IMAGE_QUEUE_EDIT_UNSUPPORTED': '无法编辑排队中的图片消息，请移除后重新发送。',
  'image.add': '添加图片',
  'image.remove': '移除图片',
  'image.attachment': '图片附件',
  'image.hint': '最多 2 张，每张 256 KiB。模型支持情况不同；动画可能仅使用首帧。',
  'image.dimensions': '图片最多为 4000 万像素，单边不超过 16,384 像素。',
  'image.unsupported': '此运行时不支持图片传输；所选模型也可能拒绝图片。',
  'image.type': '仅支持 PNG、JPEG、WebP 和 GIF，不支持 SVG。',
  'image.originalLimit': '原始图片不能超过 10 MiB。',
  'image.invalid': '无法解码此图片。',
  'image.largeAnimated': 'WebP 和 GIF 不能超过 256 KiB 或 1600 像素。请先调整大小再添加。',
  'image.size': '无法将此图片缩小至 256 KiB 以下。',
  'image.count': '最多添加 2 张图片（总计 512 KiB）。',
  'image.textLimit': '带图片的消息最多包含 16,000 个文字字符。',
  'image.compressed': '图片将在发送前缩放或压缩，可能丢失细节。',
  'image.processing': '正在准备图片…',
  'image.loadError': '图片不可用 — 重试',
  'status.idle': '就绪',
  'status.running': '进行中',
  ...
  'topbar.deviceConnection': '设置',
  'topbar.inbox': '审批中心',
  'topbar.workspace': '工作空间',
  'sessionList.more': '{title}的更多操作',
  'sessionList.manage': '管理会话：{title}',
  'sessionList.rename': '重命名',
  'sessionList.newName': '新的会话名称',
  'sessionList.saveName': '保存名称',
  'sessionList.archive': '归档会话',
  'sessionList.cancel': '取消',
  'sessionList.failed': '会话管理失败，请重试。',
  'sessionList.failedFor': '无法更新“{title}”',
  'sessionList.dismissError': '关闭错误提示',
  'sessionList.unavailable': '此会话暂时无法更新。',
  'topbar.connectionSettings': '设置',
  ...
  'conversation.historyFailed': '历史加载失败，向上滚动可重试。',
  ...
  'queue.remove': '取消',
  'queue.steer': '插话',
  'queue.nextStep': '已插话 · 等待当前步骤结束',
  'queue.nextTurn': '排队中 · 当前回合结束后处理',
  'queue.steerHint': '在下一个步骤边界加入，不会中断当前模型回复或工具执行。',
  'context.unknown': 'Context 未知',
  'context.help': '下一次请求的上下文为估算值，最近一次请求用量由运行时上报；不是累计 token 消耗。',
  'context.estimated': '预计下一次请求',
  'context.reported': '最近一次请求',
  ...
  'execution.olderStatus': '较早快照 · 已暂停实时更新',
  'execution.liveStatus': '最新窗口 · 实时更新',
  'execution.inactiveStatus': '最新窗口 · 非活跃（不一定已完成）',
  'execution.offline': '已离线 — 显示的执行记录可能已过时。重新连接以刷新。',
  'execution.stale': '执行记录已过时 — {error}',
  'execution.loadError': '无法加载执行记录 — {error}',
  'execution.retry': '重试',
  'execution.loading': '正在加载执行记录…',
  'execution.empty': '暂无执行输出。',
  'execution.latestOutput': '最新输出',
  'execution.complete': '已完成',
  'execution.input': '输入',
  'execution.pendingResult': '尚未返回',
  'execution.inProgress': '进行中',
  'execution.role.user': '用户',
  'execution.role.assistant': '助手',
  'execution.role.error': '错误',
  'execution.older': '较早一页',
  'execution.latestReset': '返回最新记录（重置）',
  'execution.refresh': '刷新最新记录',
  'execution.pagingHint': '每页会替换当前窗口，并非连续的对话记录。浏览较早记录时会保留滚动位置并暂停实时更新。',
  'agents.aria': '后台子代理',
  ...
  'agents.detailAria': '查看「{label}」的详情',
  'agents.detailShow': '查看详情',
  'agents.detailHide': '收起详情',
  'agents.plan': '计划',
  'agents.noPlan': '这个子代理没有上报计划；运行时只知道它还在运行。',
  'agents.modeOneShot': '一次性',
  'agents.modeContinuable': '可继续',
  'agents.under': '隶属于 {label}',
  'agents.depth': '位于本会话下方第 {depth} 层',
  'agents.todoPending': '未开始',
  'agents.todoInProgress': '进行中',
  'agents.todoCompleted': '已完成',
  'agents.showAll': '显示全部 {count} 个',
  'agents.collapse': '收起',
  ...
  'create.browseHint': '如果主机尚未更新，可以直接输入路径。',
  'create.useFolder': '使用这个目录',
  'create.newFolder': '新建文件夹',
  'create.folderName': '文件夹名称',
  'create.folderNameHint': '请输入单个文件夹名称，而非路径（不能包含斜杠或反斜杠，也不能为 . 或 ..）。',
  'create.createFolder': '创建文件夹',
  'create.creatingFolder': '正在创建文件夹…',
  'create.runtime': '运行时',
  ...
  'connection.remember': '在此浏览器记住连接',
  'settings.currentConnection': '当前连接',
  'settings.savedHost': '已保存的主机',
  'settings.replaceConnection': '更换连接',
  'settings.disconnect': '断开并忘记连接',
  'settings.back': '返回',
  'settings.cancel': '取消',
  'settings.rememberHint': '仅在自己的设备上开启。这会在此浏览器保存连接凭据，不会授予额外权限。',
  'settings.storageFailed': '无法更新浏览器存储，偏好未更改。请检查存储权限后重试。',
  'settings.invalidConnection': '连接信息无效，请检查配对码或主机地址与令牌。原有连接未被替换。',
  'inbox.rememberHint': '开启通知不会自动记住连接。如需关闭浏览器后再次连接，请在设置中开启记住连接。',
  ...
  'error.QUEUE_ITEM_STARTED': '这条提示已经开始执行，无法撤回。',
