...
const client = { async request(method: string, args: any) { fixture.calls.push({ method, ...args }); await new Promise(resolve => setTimeout(resolve, fixture.delay)); if (fixture.fail) throw new Error('Fixture RPC failure'); return method === 'session.image' ? { attachment, data, offset: 0, nextOffset: null } : {}; } };
function Fixture() {
