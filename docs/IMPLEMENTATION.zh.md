...
DSH 源码参照：`deepseek-ai/deepseek-harness` 的 `5dda764ed3aa172535a7967b06ff95d9cbfe536a`（2026-09-09），版本 `0.1.5-alpha.1`。其 API Gateway 使用 `POST /api/<namespace>/<method>`，并携带 Connection `client-request` 信封，其中包含 `payload: { args }`。精确签名与实机校验见 `docs/DSH.zh.md`。
